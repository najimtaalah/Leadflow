...
import { actionCreateSessionExamenTheorique } from "../actions";

export function CreateSessionExamenTheoriqueDialog() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await actionCreateSessionExamenTheorique({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Créer une session d&apos;examen théorique</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 mt-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              ...
              <Input id="lieu" name="lieu" placeholder="ex : Centre d'examen" />
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Input id="capacite_max" name="capacite_max" type="number" min={1} defaultValue={30} />
          </div>
