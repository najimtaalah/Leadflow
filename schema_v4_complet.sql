-- ============================================================
-- LeadFlow CRM — Schéma BDD v4 COMPLET
-- 27 tables + 3 vues
...
-- type_session : 'cours'  = session pédagogique réelle
--                'edof'   = session d'inscription officielle CPF/EDOF
...
-- ────────────────────────────────────────────────────────────
-- 13. DOSSIERS
-- session_cours_id : session pédagogique suivie par l'apprenant
-- session_edof_id  : session d'inscription officielle CPF/EDOF
-- examen_id        : session d'examen
-- ────────────────────────────────────────────────────────────
...
-- Auto-génération référence ADM_XXXXX
DELIMITER $$
CREATE TRIGGER IF NOT EXISTS trg_dossier_reference
...
-- ────────────────────────────────────────────────────────────
-- 14. INSCRIPTIONS (supprimée — remplacée par les FK directes
--     session_cours_id / session_edof_id / examen_id sur dossiers)
-- ────────────────────────────────────────────────────────────
